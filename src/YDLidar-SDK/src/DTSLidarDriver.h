...
// Command codes for DTS LiDAR - defined only if not already defined by other drivers
#ifndef SDK_DTS_POINT_COUNT
...
// Use DTS-specific command codes to avoid conflicts with other drivers
#define DTS_SDK_CMD_STARTSCAN 0x01 //开启测距
#define DTS_SDK_CMD_STOPSCAN 0x02 //停止测距

// Compatibility macros - only define if not already defined
#ifndef SDK_CMD_STARTSCAN
#define SDK_CMD_STARTSCAN DTS_SDK_CMD_STARTSCAN
#define SDK_CMD_STOPSCAN DTS_SDK_CMD_STOPSCAN
#endif
